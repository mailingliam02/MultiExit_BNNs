...
class VGG(nn.Module):
    ...
    def __init__(self, blocks, num_class=100):
        ...
        self.non_sequentialized_classifier = [nn.Linear(512, 4096),
...
class VGG19(VGG):
    def __init__(self, n_exits = 1, out_dim = 100, *args,  **kwargs):
        ...
        super().__init__(make_layers(cfg, batch_norm=True), num_classes=out_dim, *args,  **kwargs)
...
class VGG19EarlyExit(VGG19):
    def __init__(self,n_exits = 4, out_dim = 100, *args,  **kwargs):
        ...
        ex1featureextractor_list = [ex1conv1,ex1bn1,ex1relu1,ex1conv2,ex1bn2,ex1relu2,ex1conv3,ex1bn3,ex1relu3]
        ...
        ex2featureextractor_list = [ex2conv1,ex2bn1,ex2relu1,ex2conv2,ex2bn2,ex2relu2]
