...
class VGG19EarlyExit(VGG19):
    def __init__(self,n_exits = 4, out_dim = 100, *args,  **kwargs):
        ...
        self.ex1linear = make_classifier(self.image_size, out_dim) 
        ...
        self.ex2linear = make_classifier(self.image_size, out_dim) 
        ...
        self.ex3linear = make_classifier(self.image_size, out_dim) 

        self.ex4linear = make_classifier(self.image_size, out_dim) 
